package com._09.messageSourceAware.test;
...
import com._09.messageSourceAware.service.MessageService;

public class MessageSourceAwareTest {

	public static void main(String[] args) {

		ApplicationContext ctx = new ClassPathXmlApplicationContext("09.messageSourceAware.xml");
